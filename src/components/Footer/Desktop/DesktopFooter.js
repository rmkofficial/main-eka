...
const IconLink = styled(Typography)(({ theme }) => ({
    display: 'flex',
    alignItems: 'center',
    color: '#fff',
            ...
            <FooterContainer maxWidth="lg">
                <Column>
                    ...
                    <ScrollLink to="hero" smooth={true} duration={500}>
                        <NavLink component="span">Ana Sayfa</NavLink>
                    </ScrollLink>
                    <NavLink component="span">Hizmetler</NavLink>
                    <ScrollLink to="about-section" smooth={true} duration={500}>
                        <NavLink component="span">Hakkımızda</NavLink>
                    </ScrollLink>
                    <ScrollLink to="contact-section" smooth={true} duration={500}>
                        <NavLink component="span">İletişim</NavLink>
                    </ScrollLink>
                </Column>
                <Column>
                    <Logo />
                ...
                <Column>
                    ...
                    <a href="tel:+901234567890" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <IconLink component="span">
                            <PhoneIcon />
